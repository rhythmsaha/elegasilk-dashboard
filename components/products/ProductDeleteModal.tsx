...
const ProductDeleteModal: FC<Props> = ({ id, isOpen, onDelete, onOpenChange }) => {
    const [isloading, setIsloading] = useState(false);

    const productDeleteHandler = async (id: string, onDelete: (id: string) => void) => {
        if (isloading) return;
    ...
    const deleteHandler = async (closeFn: () => void) => {
        productDeleteHandler(id, onDelete);
        closeFn();
    };
                        ...
                        <ModalBody className="py-8">
                            <div className="flex flex-col items-center  gap-4 md:flex-row md:items-start">
                                ...
                                <div className="text-center md:text-left">
                                    <h4 className="text-base font-semibold leading-6 text-gray-900">Delete Product</h4>
                                    <div className="mt-2">
