import useDeleteSubCategory from '@/hooks/subcategory/useDeleteSubCategoryt';
...
const SubCategoryDeleteModal: FC<Props> = ({ isOpen, onOpenChange, id, onDelete }) => {
    const { deleteSubCategory, isLoading } = useDeleteSubCategory();

    const deleteHandler = async (closeFn: () => void) => {
        deleteSubCategory(id, onDelete);
        closeFn();
    };
