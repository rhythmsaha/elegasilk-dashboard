...
const CollectionDeleteModal: FC<Props> = ({ id, isOpen, onDelete, onOpenChange }) => {
    const { collectionDeleteHandler, isLoading } = useDeleteCollection();

    const deleteHandler = async (closeFn: () => void) => {
        collectionDeleteHandler(id, onDelete);
        closeFn();
    };
                                ...
                                <div className="text-center md:text-left">
                                    ...
                                    <div className="mt-2">
                                        <p className="text-sm text-gray-500">
                                            Are you sure you want to Delete This Collection? All of your data will be permanently removed. This action cannot be undone.
                                        </p>
                                    </div>
                                </div>
                            </div>
